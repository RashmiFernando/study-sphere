  ...
  <div className="px-10 py-5">
    ...
    <table className="w-full bg-white shadow-md border border-gray-300">
      <thead className="bg-orange-600 text-white">
        <tr>
          <th className="p-3 border bg-orange-700">Course Code</th>
          <th className="p-3 border bg-orange-700">Exam Name</th>
          <th className="p-3 border bg-orange-700">Date</th>
          <th className="p-3 border bg-orange-700">Duration</th>
        </tr>
      </thead>
      <tbody>
        {exams.length === 0 ? (
          ...
          exams.map((exam, index) => (
            <tr key={index} className="hover:bg-orange-50">
              ...
              <td className="p-3 border text-center">{exam.examDuration} mins</td>
            </tr>
          ))
        )}
      </tbody>
